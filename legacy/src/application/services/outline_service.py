...
class OutlineService:
    ...
    async def _extract_story_start_date(
        ...
        prompt_content = self.prompt_loader.load_prompt(
            "outline/extract_story_start_date", variables={"prompt": prompt}
        )
    ...
    async def _extract_base_context(
        ...
        prompt_content = self.prompt_loader.load_prompt(
            "outline/extract_base_context", variables={"prompt": prompt}
        )
    ...
    async def _generate_story_elements(
        ...
        prompt_content = self.prompt_loader.load_prompt(
            "outline-chapter/outline/create_elements", variables={"prompt": prompt}
        )
