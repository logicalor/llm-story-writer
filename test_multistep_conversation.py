...
async def test_specific_provider_conversation():
    ...
    system_message = (
        input("Enter system message (or press Enter for none): ").strip() or None
    )
...
async def test_conversation_memory():
    ...
    print(
        "This will test if the AI remembers ArtBot-3000's name and the world setting across all steps."
    )
    ...
    try:
        ...
        if "ArtBot-3000" in response and "forgotten how to create art" in response:
            ...
            print(
                "Expected to see 'ArtBot-3000' and 'forgotten how to create art' in the final response."
            )
