...
description: Independent code review sub-agent running on Gemini 3.1 Pro (Preview). Reviews local branch changes against development and returns a structured report to the Synthesizing Reviewer. Not invoked directly by users.
