---
name: Auditor (Qwen)
description: Independent audit sub-agent running on Qwen 3.6. Performs the standard audit process and returns a structured report to the Synthesizing Auditor. Not invoked directly by users.
