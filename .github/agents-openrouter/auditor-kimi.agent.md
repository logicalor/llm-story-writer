---
name: Auditor (Kimi)
description: Independent audit sub-agent running on MoonshotAI: Kimi K2.6
. Performs the standard audit process and returns a structured report to the Synthesizing Auditor. Not invoked directly by users.
