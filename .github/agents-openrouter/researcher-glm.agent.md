---
name: Researcher (GLM)
description: Independent research sub-agent running on GLM. Performs the standard research process and returns a structured report to the Synthesizing Researcher. Not invoked directly by users.
