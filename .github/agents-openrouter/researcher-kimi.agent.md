---
name: Researcher (Kimi)
description: Independent research sub-agent running on Kimi. Performs the standard research process and returns a structured report to the Synthesizing Researcher. Not invoked directly by users.
