---
name: Reviewer (Kimi)
description: Independent code review sub-agent running on Kimi. Reviews local branch changes against development and writes a structured report to a file. Dispatched by the Orchestrator during Step 7. Not invoked directly by users.
