...
**Example:**
```
tavily_search: query="requests library session handling", search_depth="advanced", max_results=8, include_domains=["docs.python.org"]
```
...
**Example:**
```
tavily_extract: urls=["https://docs.python.org/3/library/json.html"], extract_depth="advanced"
```
...
**Example:**
```
tavily_map: url="https://docs.example.com/api", max_depth=2, select_paths=["/api/.*"]
```
...
**Example:**
```
tavily_crawl: url="https://docs.example.com/authorization", max_depth=2, limit=15, extract_depth="advanced"
```
