<!-- STALE — archived to archive/issue-318-names-cache-return-regression-2026-05-03.md — delete this file -->
---
date: "2026-05-03"
issue: 318
pr: 330
...
> A defensive exclusion filter at the return site (`return [p for p in written if p != cache]`)
> is an acceptable fix when the contract is clear, but prefer not appending the non-output path.
