<!-- Archived — see archive/issue-113-tool-interface-verification-2026-04-21.md -->
...
**Change 3 — Review checklist Phase 1** (`.github/agents/_shared/review-checklist.md`):
...
- Added a companion file concept sweep item to Phase 1 of the review checklist.
