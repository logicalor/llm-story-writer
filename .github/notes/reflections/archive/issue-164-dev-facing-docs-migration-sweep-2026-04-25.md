...
This also consolidates the source attribution with the issue #158 finding (which already applied the `AGENTS.md` and `.github/notes/` entries) by appending the issue #164 source to that sub-bullet.
